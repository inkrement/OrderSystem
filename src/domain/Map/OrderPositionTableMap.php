...
class OrderPositionTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->addForeignPrimaryKey('order_id', 'OrderId', 'INTEGER' , 'ordertbl', 'id', true, null, null);
  ...
  array (
     ...
     * and findPk*() calls.
     *
     * @param \OrderPosition $obj A \OrderPosition object.
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize(array((string) $obj->getId(), (string) $obj->getOrderId(), (string) $obj->getProductId()));
            } // if key === null
     ...
     *
     * @param mixed $value A \OrderPosition object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \OrderPosition) {
                $key = serialize(array((string) $value->getId(), (string) $value->getOrderId(), (string) $value->getProductId()));
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \OrderPosition object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('OrderId', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 2 + $offset : static::translateFieldName('ProductId', TableMap::TYPE_PHPNAME, $indexType)]));
    }
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(OrderPositionTableMap::COL_ID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(OrderPositionTableMap::COL_ORDER_ID, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(OrderPositionTableMap::COL_PRODUCT_ID, $value[2]));
