...
class OrderTableMap extends TableMap
{
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('OrderPosition', '\\OrderPosition', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':order_id',
    1 => ':id',
  ),
), 'CASCADE', null, 'OrderPositions', false);
    } // buildRelations()
    ...
    /**
     * Method to invalidate the instance pool of all tables related to ordertbl     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        return serialize(array((string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)], (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)]));
    }
