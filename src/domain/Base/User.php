...
abstract class User implements ActiveRecordInterface
{
     ...
     * Note: this column has a database default value of: 'customer'
     * @var        string
     */
    protected $role;
    ...
    public function setPlz($v)
    {
        ...
        if ($this->plz !== $v) {
            $this->plz = $v;
            $this->modifiedColumns[UserTableMap::COL_PLZ] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : UserTableMap::translateFieldName('Plz', TableMap::TYPE_PHPNAME, $indexType)];
            $this->plz = (null !== $col) ? (int) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PLZ)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'phone':
                        ...
                        break;
                    case 'plz':
                        $stmt->bindValue($identifier, $this->plz, PDO::PARAM_INT);
                        break;
                    case 'city':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_PLZ)) {
            $criteria->add(UserTableMap::COL_PLZ, $this->plz);
        }
        if ($this->isColumnModified(UserTableMap::COL_CITY)) {
