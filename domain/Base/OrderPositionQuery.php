...
abstract class OrderPositionQuery extends ModelCriteria
{
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = OrderPositionTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT id, order_id, product_id, quantity FROM orderposition WHERE id = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            OrderPositionTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(OrderPositionTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(OrderPositionTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterByOrder($order, $comparison = null)
    {
        if ($order instanceof \Order) {
            ...
            return $this
                ->addUsingAlias(OrderPositionTableMap::COL_ORDER_ID, $order->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($orderPosition) {
            $this->addUsingAlias(OrderPositionTableMap::COL_ID, $orderPosition->getId(), Criteria::NOT_EQUAL);
        }
