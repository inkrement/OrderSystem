...
/**
 * Base class that represents a row from the 'ordertbl' table.
 *
 *
 *
...
abstract class Order implements ActiveRecordInterface
{
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO ordertbl (%s) VALUES (%s)',
    ...
    public function setOrderPositions(Collection $orderPositions, ConnectionInterface $con = null)
    {
        ...
        $this->orderPositionsScheduledForDeletion = $orderPositionsToDelete;

        foreach ($orderPositionsToDelete as $orderPositionRemoved) {
            $orderPositionRemoved->setOrder(null);
        }
     ...
     * @return ObjectCollection|ChildOrderPosition[] List of ChildOrderPosition objects
     */
    public function getOrderPositionsJoinProduct(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildOrderPositionQuery::create(null, $criteria);
